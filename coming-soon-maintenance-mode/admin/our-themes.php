...
<div class="wrap ag-our-plugins-wrap">
    <header class="ag-our-plugins-header">
        <h1><?php esc_html_e( 'Our WordPress Themes', 'coming-soon-maintenance-mode' ); ?></h1>
        <p><?php esc_html_e( 'Beautifully crafted, high-performance themes for any WordPress project. Experience premium design and ultimate speed.', 'coming-soon-maintenance-mode' ); ?></p>
    </header>

	<?php if ( is_wp_error( $response ) ) : ?>
        <div class="ag-error-wrap">
            <span class="dashicons dashicons-warning"></span>
            <h2><?php esc_html_e( 'Unable to fetch our themes', 'coming-soon-maintenance-mode' ); ?></h2>
	...
	<?php elseif ( empty( $themes ) ) : ?>
        <div class="ag-loading-wrap">
            ...
            <h3><?php esc_html_e( 'Refreshing our theme collection...', 'coming-soon-maintenance-mode' ); ?></h3>
        </div>
	<?php else : ?>
                    ...
                    <div class="ag-plugin-content">
                        ...
                        <div class="ag-plugin-actions">
                            <a href="<?php echo esc_url( $preview_url ); ?>" target="_blank" class="ag-btn ag-btn-secondary">
								<?php esc_html_e( 'Live Preview', 'coming-soon-maintenance-mode' ); ?>
                            </a>
