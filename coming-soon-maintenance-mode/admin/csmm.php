...
$csmm_launch_dt = gmdate('Y-m-d', strtotime($csmm_current_date . ' +1 month'));
$csmm_countdown_date = gmdate('Y-m-d', strtotime($csmm_launch_dt));
				...
				<div class="tab-content" id="nav-tabContent">
							...
							<div id="maintenance-mode-options" class="row" style="<?php if($csmm_website_mode != 2 ) echo esc_attr("display:none"); ?>">
								...
								<div class="col-md-4 p-2 border bg-light">
									...
									<div class="">
										<?php $posts = get_posts(); ?>
										<div>
										<input type="checkbox" id="check-all-posts" name="csmm_posts" value="-1" <?php if(in_array( -1, $csmm_posts)) echo esc_attr("checked"); ?> />&nbsp;&nbsp;<strong><?php esc_html_e('Select All', 'coming-soon-maintenance-mode' ); ?></strong>
										</div>
								...
								<div class="col-md-4 p-2 border bg-light">
									...
									<div class="">
										<?php $pages = get_pages(); ?>
										<div>
											<input type="checkbox" id="check-all-pages" name="csmm_pages" value="-1" <?php if(in_array( -1, $csmm_pages)) echo esc_attr("checked"); ?> />&nbsp;&nbsp;<strong><?php esc_html_e('Select All', 'coming-soon-maintenance-mode'); ?></strong>
										</div>
										<?php foreach ( $pages as $page ) { ?>
										<div>
											<input type="checkbox" class="csmm-page-list" name="csmm_pages" value="<?php echo esc_attr( $page->ID ); ?>" <?php if ( in_array( $page->ID, $csmm_pages ) ) echo 'checked'; ?> />&nbsp;&nbsp;<?php echo esc_html( $page->post_title ); ?>										</div>
										<?php } ?>
									</div>
								</div>
								<div class="col-md-4 p-2 border bg-light">
									...
									<div class="">
										<div>
										<input type="checkbox" id="check-all-other-pages" name="csmm_other_pages" value="-1" <?php if(in_array( -1, $csmm_other_pages)) echo esc_attr("checked"); ?> />&nbsp;&nbsp;<strong><?php esc_html_e('Select All', 'coming-soon-maintenance-mode'); ?></strong>
										</div>
										<div>
										<input type="checkbox" class="csmm-other-page-list" name="csmm_other_pages" value="front" <?php if(in_array( "front", $csmm_other_pages)) echo esc_attr("checked"); ?> />&nbsp;&nbsp; <a href="https://developer.wordpress.org/reference/functions/is_front_page/" target="_blank"><?php esc_html_e('Front Page', 'coming-soon-maintenance-mode'); ?></a>
										</div>
										<div>
										<input type="checkbox" class="csmm-other-page-list" name="csmm_other_pages" value="home" <?php if(in_array( "home", $csmm_other_pages)) echo esc_attr("checked"); ?> />&nbsp;&nbsp; <a href="https://developer.wordpress.org/reference/functions/is_home/" target="_blank"><?php esc_html_e('Home Page', 'coming-soon-maintenance-mode'); ?></a>
										</div>
										<div>
										<input type="checkbox" class="csmm-other-page-list" name="csmm_other_pages" value="category" <?php if(in_array( "category", $csmm_other_pages)) echo esc_attr("checked"); ?> />&nbsp;&nbsp; <a href="https://developer.wordpress.org/reference/functions/is_category/" target="_blank"><?php esc_html_e('Category Page', 'coming-soon-maintenance-mode'); ?></a>
										</div>
										<div>
										<input type="checkbox" class="csmm-other-page-list" name="csmm_other_pages" value="tag" <?php if(in_array( "tag", $csmm_other_pages)) echo esc_attr("checked"); ?> />&nbsp;&nbsp; <a href="https://developer.wordpress.org/reference/functions/is_tag/" target="_blank"><?php esc_html_e('Tag Page', 'coming-soon-maintenance-mode'); ?></a>
										</div>
										<div>
										<input type="checkbox" class="csmm-other-page-list" name="csmm_other_pages" value="search" <?php if(in_array( "search", $csmm_other_pages)) echo esc_attr("checked"); ?> />&nbsp;&nbsp; <a href="https://developer.wordpress.org/reference/functions/is_search/" target="_blank"><?php esc_html_e('Search Page', 'coming-soon-maintenance-mode'); ?></a>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="tab-pane fade" id="nav-templates" role="tabpanel" aria-labelledby="nav-templates-tab" tabindex="0">
						<div class="col-md-12 p-2 mt-3">
							...
							<div id="csmm-templates-info-2" class="form-text"><span class="badge text-bg-info"><?php esc_html_e( 'Important Note', 'coming-soon-maintenance-mode' ); ?></span> Only <strong>Template 1, 4, 8 and 11, 15 </strong> is available in free version.</div>
						</div>
						<div class="row">
							<div class="col-md-6 p-2">
								<div class="p-4">
